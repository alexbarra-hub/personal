    ...
    <section className="w-full h-screen relative flex flex-col p-8 md:p-16 border-b-[4px] border-[var(--c-red)] overflow-y-auto" style={{ backgroundColor: 'var(--c-teal)', color: 'var(--c-black)' }}>
      ...
      <div className="max-w-3xl space-y-8 relative z-10">
        <div className="border-2 border-[var(--c-black)] p-8 bg-[var(--c-pink)]">
          ...
          <p className="text-mono text-lg leading-relaxed">
        ...
        <div className="border-2 border-[var(--c-black)] p-8 bg-[var(--c-pink)]">
          ...
          <p className="text-mono text-lg leading-relaxed mb-4">
            I build products from zero to one. My work spans across:
          </p>
          <ul className="text-mono text-lg space-y-2 list-none">
        ...
        <div className="border-2 border-[var(--c-black)] p-8 bg-[var(--c-pink)]">
          ...
          <p className="text-mono text-lg leading-relaxed mb-6">
          ...
          <div className="flex flex-wrap gap-4">
            <a
              ...
              className="text-mono px-6 py-3 border-2 border-[var(--c-black)] hover:bg-[var(--c-red)] hover:text-[var(--c-pink)] hover:border-[var(--c-red)] transition-all"
            >
              LINKEDIN
            </a>
            <a
