  ...
  return (
    <section className="w-full h-screen relative flex flex-col p-8 md:p-16 pb-24 border-b-[4px] border-[var(--c-red)] overflow-y-auto" style={{ backgroundColor: 'var(--c-pink)', color: 'var(--c-red)' }}>
      ...
      <div className="relative z-10 mt-16 mb-12">
        <h2 className="text-7xl md:text-8xl font-black mb-6" style={{ color: 'var(--c-red)' }}>
          ABOUT
        </h2>
      ...
      <div className="max-w-6xl mx-auto space-y-8 relative z-10 mb-16">
        <div className="border-4 border-[var(--c-red)] p-0 bg-[var(--c-black)] grid md:grid-cols-[350px,1fr] gap-0 overflow-hidden transform hover:scale-[1.01] transition-transform duration-300">
          ...
          <div className="p-10 md:p-12 flex flex-col justify-center" style={{ backgroundColor: 'var(--c-black)' }}>
            <div className="flex items-center gap-4 mb-8">
              <Lightbulb size={36} style={{ color: 'var(--c-teal)' }} />
              <h3 className="text-mono text-4xl font-black" style={{ color: 'var(--c-red)', letterSpacing: '0.02em' }}>
                WHO I AM
              </h3>
            </div>
            <p className="text-mono text-2xl leading-loose mb-6" style={{ color: 'var(--c-white)', fontWeight: '500', letterSpacing: '0.02em', lineHeight: '1.7' }}>
            ...
            <p className="text-mono text-2xl leading-loose" style={{ color: 'var(--c-white)', fontWeight: '500', letterSpacing: '0.02em', lineHeight: '1.7' }}>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="border-4 border-[var(--c-red)] p-10 bg-[var(--c-black)] transform hover:translate-y-[-4px] transition-transform duration-300 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 opacity-10" style={{ color: 'var(--c-teal)' }}>
              <Target size={128} />
            </div>
            <div className="flex items-center gap-4 mb-8">
              <Target size={32} style={{ color: 'var(--c-teal)' }} />
              <h3 className="text-mono text-3xl font-black" style={{ color: 'var(--c-red)', letterSpacing: '0.02em' }}>
                WHAT I DO
              </h3>
            </div>
          ...
          <div className="border-4 border-[var(--c-red)] p-10 bg-[var(--c-black)] transform hover:translate-y-[-4px] transition-transform duration-300 relative overflow-hidden">
            ...
            <div className="flex items-center gap-4 mb-8">
              <GraduationCap size={32} style={{ color: 'var(--c-teal)' }} />
              <h3 className="text-mono text-3xl font-black" style={{ color: 'var(--c-red)', letterSpacing: '0.02em' }}>
                EDUCATION
              </h3>
            </div>
            <div className="space-y-6 relative z-10">
              <div>
                <p className="text-mono font-black text-xl mb-2" style={{ color: 'var(--c-white)', letterSpacing: '0.02em' }}>UC Berkeley, Haas</p>
                <p className="text-mono text-lg" style={{ color: 'var(--c-teal)', fontWeight: '500', letterSpacing: '0.02em' }}>MBA Candidate, Expected 2028</p>
              </div>
              <div>
                <p className="text-mono font-black text-xl mb-2" style={{ color: 'var(--c-white)', letterSpacing: '0.02em' }}>Cornell University</p>
                <p className="text-mono text-lg" style={{ color: 'var(--c-teal)', fontWeight: '500', letterSpacing: '0.02em' }}>BS Industrial & Labor Relations, 2013</p>
              </div>
              <div className="pt-4 border-t-2" style={{ borderColor: 'var(--c-red)' }}>
                <p className="text-mono text-lg leading-relaxed" style={{ color: 'var(--c-white)', fontWeight: '500', letterSpacing: '0.02em', lineHeight: '1.6' }}>
        ...
        <div className="border-4 border-[var(--c-red)] p-10 md:p-12 bg-[var(--c-black)]">
          <div className="flex items-center gap-4 mb-10">
            <Briefcase size={36} style={{ color: 'var(--c-teal)' }} />
            <h3 className="text-mono text-4xl font-black" style={{ color: 'var(--c-red)', letterSpacing: '0.02em' }}>
              EXPERIENCE
            </h3>
          </div>
          ...
          <div className="space-y-8">
            <div className="border-l-4 pl-8 pb-8 relative" style={{ borderColor: 'var(--c-teal)' }}>
              <div className="absolute left-[-8px] top-0 w-3 h-3 rounded-full" style={{ backgroundColor: 'var(--c-teal)' }}></div>
              <div className="flex items-start gap-4 mb-4">
                <div className="flex-1">
                  <p className="text-mono font-black text-2xl mb-2" style={{ color: 'var(--c-red)', letterSpacing: '0.02em' }}>DELTA DENTAL OF CALIFORNIA</p>
                  <p className="text-mono text-lg mb-2" style={{ color: 'var(--c-white)', letterSpacing: '0.02em' }}>Senior Organizational Effectiveness Consultant (Tech & Quality)</p>
                  <p className="text-mono text-base" style={{ color: 'var(--c-teal)' }}>Feb 2024 - Present</p>
                </div>
              </div>
              <ul className="text-mono text-lg space-y-3 list-none mt-4" style={{ color: 'var(--c-white)', fontWeight: '500', letterSpacing: '0.02em', lineHeight: '1.6' }}>
                <li className="flex items-start gap-3">
                  <span style={{ color: 'var(--c-teal)', fontSize: '1.25rem' }}>•</span>
            ...
            <div className="border-l-4 pl-8 pb-8 relative" style={{ borderColor: 'var(--c-teal)' }}>
              ...
              <div className="flex items-start gap-4 mb-4">
                <div className="flex-1">
                  <p className="text-mono font-black text-2xl mb-2" style={{ color: 'var(--c-red)', letterSpacing: '0.02em' }}>BARRA CONSULTING</p>
                  <p className="text-mono text-lg mb-2" style={{ color: 'var(--c-white)', letterSpacing: '0.02em' }}>Founder & Principal Consultant</p>
                  <p className="text-mono text-base" style={{ color: 'var(--c-teal)' }}>Feb 2024 - Present</p>
                </div>
              </div>
              <ul className="text-mono text-lg space-y-3 list-none mt-4" style={{ color: 'var(--c-white)', fontWeight: '500', letterSpacing: '0.02em', lineHeight: '1.6' }}>
            ...
            <div className="border-l-4 pl-8 pb-8 relative" style={{ borderColor: 'var(--c-teal)' }}>
              ...
              <div className="flex items-start gap-4 mb-4">
                <div className="flex-1">
                  <p className="text-mono font-black text-2xl mb-2" style={{ color: 'var(--c-red)', letterSpacing: '0.02em' }}>PROPELLER CONSULTING</p>
                  <p className="text-mono text-lg mb-2" style={{ color: 'var(--c-white)', letterSpacing: '0.02em' }}>Management Consultant</p>
                  <p className="text-mono text-base" style={{ color: 'var(--c-teal)' }}>Oct 2021 - Feb 2024</p>
                </div>
              </div>
              <ul className="text-mono text-lg space-y-3 list-none mt-4" style={{ color: 'var(--c-white)', fontWeight: '500', letterSpacing: '0.02em', lineHeight: '1.6' }}>
                <li className="flex items-start gap-3">
            ...
            <div className="border-l-4 pl-8 pb-8 relative" style={{ borderColor: 'var(--c-teal)' }}>
              ...
              <div className="flex items-start gap-4 mb-4">
                <div className="flex-1">
                  <p className="text-mono font-black text-2xl mb-2" style={{ color: 'var(--c-red)', letterSpacing: '0.02em' }}>LOCKHEED MARTIN</p>
                  <p className="text-mono text-lg mb-2" style={{ color: 'var(--c-white)', letterSpacing: '0.02em' }}>HR Transformation Program Manager & Talent Development Consultant</p>
                  <p className="text-mono text-base" style={{ color: 'var(--c-teal)' }}>Oct 2016 - Oct 2021</p>
                </div>
              </div>
              <ul className="text-mono text-lg space-y-3 list-none mt-4" style={{ color: 'var(--c-white)', fontWeight: '500', letterSpacing: '0.02em', lineHeight: '1.6' }}>
                <li className="flex items-start gap-3">
            ...
            <div className="border-l-4 pl-8 relative" style={{ borderColor: 'var(--c-teal)' }}>
              <div className="absolute left-[-8px] top-0 w-3 h-3 rounded-full" style={{ backgroundColor: 'var(--c-teal)' }}></div>
              <div className="flex items-start gap-4 mb-4">
                <div className="flex-1">
                  <p className="text-mono font-black text-2xl mb-2" style={{ color: 'var(--c-red)', letterSpacing: '0.02em' }}>SIKORSKY AIRCRAFT</p>
                  <p className="text-mono text-lg mb-2" style={{ color: 'var(--c-white)', letterSpacing: '0.02em' }}>HR Business Partner & Industrial Relations</p>
                  <p className="text-mono text-base" style={{ color: 'var(--c-teal)' }}>Jul 2013 - Oct 2016</p>
                </div>
              </div>
              <ul className="text-mono text-lg space-y-3 list-none mt-4" style={{ color: 'var(--c-white)', fontWeight: '500', letterSpacing: '0.02em', lineHeight: '1.6' }}>
                <li className="flex items-start gap-3">
        ...
        <div className="border-4 border-[var(--c-red)] p-10 md:p-12 bg-gradient-to-br from-[var(--c-black)] to-[var(--c-teal)] bg-opacity-10 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h3 className="text-mono text-4xl font-black mb-8 text-center" style={{ color: 'var(--c-red)', letterSpacing: '0.02em' }}>
              LET'S CONNECT
            </h3>
            <p className="text-mono text-2xl leading-relaxed mb-10 text-center max-w-2xl mx-auto" style={{ color: 'var(--c-white)', fontWeight: '500', letterSpacing: '0.02em', lineHeight: '1.7' }}>
            ...
            <div className="flex flex-wrap gap-6 justify-center">
              <a
                ...
                className="text-mono text-lg px-10 py-5 border-3 border-[var(--c-red)] bg-[var(--c-red)] text-[var(--c-black)] hover:bg-transparent hover:text-[var(--c-red)] transition-all font-black transform hover:scale-105"
              >
                LINKEDIN
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-mono text-lg px-10 py-5 border-3 border-[var(--c-teal)] bg-[var(--c-teal)] text-[var(--c-black)] hover:bg-transparent hover:text-[var(--c-teal)] transition-all font-black transform hover:scale-105"
              >
                GITHUB
              </a>
            </div>
